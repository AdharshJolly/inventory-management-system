...
## Vision
A full-stack Inventory Management System built with React, Node.js (Express), and MongoDB, designed to bridge the gap between academic RDBMS concepts and professional portfolio applications. The system provides a seamless experience for managing the lifecycle of products, from supplier acquisition to inventory transactions.

## Target Users
- **Warehouse Managers:** Oversee stock levels, monitor inventory health, and manage low-stock alerts.
- **Procurement Officers:** Manage relationships with suppliers and coordinate product intake.
- **Store Clerks:** Execute daily IN/OUT transactions and maintain accurate real-time records.
...
## Key Features
- **Inventory Dashboard:** A centralized hub displaying key statistics and proactive low-stock alerts using MongoDB aggregation.
...
- **Responsive Data Views:** Specialized card-based layouts for mobile devices to provide optimal visibility without horizontal scrolling.
...
- **Mobile-First Navigation:** Smooth, gesture-friendly sidebar drawer and touch-optimized interfaces for on-the-go inventory management.
